...
**Accounts**:
  ...
  * [Get account](#get-account) — retrieves the authentication key and the sequence number for an account address.
  * [Get account resources](#get-account-resources) — retrieves all account resources for a given account and a specific ledger version.
  * [Get account modules](#get-account-modules) — retrieves all account modules' bytecode for a given account at a specific ledger version.
  * [Get account resource](#get-account-resource) — retrieves an individual resource from a given account and at a specific ledger version.
  * [Get account module](#get-account-module) — retrieves an individual module from a given account and at a specific ledger version.

**Blocks**:

  * [Get blocks by height](#get-blocks-by-height) — retrieves the transactions in a block and the corresponding block information.
  * [Get blocks by version](#get-blocks-by-version) — retrieves the transactions in a block and the corresponding block information by version in the block.

**Events**:

  * [Get events by creation number](#get-events-by-creation-number) — retrieves events by creation number.
  * [Get events by event handle](#get-events-by-event-handle) — retrieves events by event handle.

**General**:

  * [Get ledger info](#get-ledger-info) — retrieves the latest ledger information.

**Table**:

  * [Get table item](#get-table-item) — retrieves a table item.
  * [Get raw table item](#get-raw-table-item) — retrieves a raw table item.

**Transactions**:

  * [Get transactions](#get-transactions) — retrieves on-chain committed transactions.
  * [Submit transaction](#submit-transaction) — submits a transaction in JSON or BCS.
  * [Get transaction by hash](#get-transaction-by-hash) — retrieves a transaction by its hash.
  * [Get transaction by version](#get-transaction-by-version) — retrieves a transaction by a given version.
  * [Get account transactions](#get-account-transactions) — retrieves on-chain committed transactions from an account.
  * [Submit batch transactions](#submit-batch-transactions) — submits multiple transactions.
  * [Simulate transaction](#simulate-transaction) — simulates transaction submission.
  * [Encode submission](#encode-submission) — accepts an EncodeSubmissionRequest, which internally is a UserTransactionRequestInner (and optionally secondary signers) encoded as JSON, validates the request format, and then returns that request encoded in BCS.
  * [Estimate gas price](#estimate-gas-price) — estimates gas price.

**View**:

  * [Execute view function of a module](#execute-view-function-of-a-module) — executes the Move function with the given parameters and return its execution result.
...
To retrieve a pending transaction, use [Get transactions by hash](#get-transaction-by-hash).
...
To retrieve a pending transaction, use [Get transaction by hash](#get-transaction-by-hash).
